...
This is an example project that demonstrates how to configure Nunit Framework to generate the JUnit XML results file required for uploading test results to Zephyr Scale or Zephyr Squad.
...
namespace UnitTest
{
    public class Tests
    {
        ...
        [Test]
        public void Test_SubstractMethod()  //  this will match Zephyr Scale or Zephyr Squad test case named UnitTest.Test.Test_SubstractMethod 
        {
            double res = 10 - 10;
        ...
        [TestCase(2, 2, 4)]
        [TestCase(0, 5, 5)]
        public void Test_AddMethod_NET_T1743(double a, double b, double c) // this will match Zephyr Scale or Zephyr Squad test case with key NET-T1743
        {
            double res = a + b;
        ...
        [Test]
        public void NET_T1744_DivideMethod() // this will match Zephyr Scale or Zephyr Squad test case with key NET-T1744
        {
...
```
As we can see, the first tests will match Zephyr Scale or Zephyr Squad test cases by name and the last 2 will match by key.
