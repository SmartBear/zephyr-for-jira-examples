...
*** Test Cases ***
# will match Zephyr test case named Calculator.User can clear the display
...
*** Test Cases ***
# will match Zephyr test case with key VIC-T14
...
*** Test Cases ***
# will match Zephyr test case with key VIC-T9
